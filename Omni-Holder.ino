...
ExponentialFilter<long> ACCFilterX(25, 0); //DO NOT GO OVER 9000!!!!
ExponentialFilter<long> ACCFilterY(15, 0); //DO NOT GO OVER 9000!!!!
...
void loop() {
	...
	ACCFilterX.Filter(accX); //filtered acceleration	
	Servo2.write(-compAngleY + 90 - ACCFilterX.Current() / 4000);
	delay(2);

	ACCFilterY.Filter(accY);
	Servo1.write(-compAngleX + 90 - ACCFilterY.Current() / 4000);
	delay(2);
}
